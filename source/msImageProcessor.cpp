...
//ranqing	if((ErrorStatus = msSys.Progress((float)(0.0))) == EL_HALT)
//ranqing	{
//ranqing		return;
//ranqing	}
	...
	//start timer
//ranqing #ifdef PROMPT
//ranqing 	double timer;
//ranqing	msSys.StartTimer();
//ranqing #endif
   ...
   // new speedup
	...
	//and exit
//ranqing	if((ErrorStatus = msSys.Progress((float)(0.8))) == EL_HALT)
//ranqing	{
//ranqing		DestroyOutput();
//ranqing		return;
//ranqing	}
...
//ranqing #ifdef PROMPT
//ranqing 	timer	= msSys.ElapsedTime();
//ranqing 	msSys.Prompt("(%6.2f sec)\nConnecting regions         ...", timer);
//ranqing 	msSys.StartTimer();
//ranqing #endif
...
//ranqing #ifdef PROMPT
//ranqing 	timer	= msSys.ElapsedTime();
//ranqing 	msSys.Prompt("done. (%6.2f seconds, numRegions = %6d)\n", timer, regionCount);
//ranqing 	msSys.StartTimer();
//ranqing #endif
...
//ranqing 	if((ErrorStatus = msSys.Progress((float)(0.8))) == EL_HALT)
//ranqing 	{
//ranqing 		if(class_state.OUTPUT_DEFINED)	DestroyOutput();
//ranqing 		return;
//ranqing 	}
...
//ranqing #ifdef PROMPT
//ranqing 		msSys.Prompt("Connecting regions         ...");
//ranqing 		msSys.StartTimer();
//ranqing #endif
...
//ranqing #ifdef PROMPT
//ranqing 		double timer	= msSys.ElapsedTime();
//ranqing 		msSys.Prompt("done. (%6.2f seconds, numRegions = %6d)\n", timer, regionCount);
//ranqing #endif
	...
	//Check to see if the algorithm is to be halted, if so then
	//destroy output and exit
//ranqing 	if((ErrorStatus = msSys.Progress((float)(0.85))) == EL_HALT)
//ranqing 	{
//ranqing 		DestroyOutput();
//ranqing 		return;
//ranqing 	}
...
//ranqing #ifdef PROMPT
//ranqing 	msSys.Prompt("Applying transitive closure...");
//ranqing 	msSys.StartTimer();
//ranqing #endif
...
//ranqing 	if((ErrorStatus = msSys.Progress((float)(1.0))) == EL_HALT)
//ranqing 	{
//ranqing 		DestroyRAM();
//ranqing 		DestroyOutput();
//ranqing 		return;
...
//ranqing 	if((ErrorStatus = msSys.Progress((float)(0.95))) == EL_HALT)
//ranqing 	{
//ranqing 		DestroyRAM();
//ranqing 		DestroyOutput();
//ranqing 		return;
...
//ranqing #endif
	...
	//Check to see if the algorithm is to be halted, if so then
	//destroy output and regions adjacency matrix and exit
//ranqing 	if((ErrorStatus = msSys.Progress(1.0)) == EL_HALT)
//ranqing 	{
//ranqing 		DestroyRAM();
//ranqing 		DestroyOutput();
//ranqing 		return;
...
void msImageProcessor::NonOptimizedFilter(float sigmaS, float sigmaR)
{
	...
	// proceed ...
//ranqing #ifdef PROMPT
//ranqing 	msSys.Prompt("done.\nApplying mean shift (Using Lattice)... ");
//ranqing #ifdef SHOW_PROGRESS
//ranqing 	msSys.Prompt("\n 0%%");
//ranqing #endif
//ranqing #endif
...
//ranqing 		if((i%PROGRESS_RATE == 0)&&((ErrorStatus = msSys.Progress((float)(i/(float)(L))*(float)(0.8)))) == EL_HALT)
//ranqing 			break;
	}
...
//ranqing #endif
	...
	for(i = 0; i < L; i++)
	{
		...
		// Prompt user on progress
//ranqing #ifdef SHOW_PROGRESS
//ranqing 		percent_complete = (float)(i/(float)(L))*100;
//ranqing 		msSys.Prompt("\r%2d%%", (int)(percent_complete + 0.5));
//ranqing #endif
